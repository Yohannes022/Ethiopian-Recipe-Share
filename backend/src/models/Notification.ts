...
import { INotification, INotificationMethods, NotificationModel } from '@/types/notification.types';

const notificationSchema = new mongoose.Schema<INotification, NotificationModel, INotificationMethods>(
  {
    user: {
